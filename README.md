...
| v1.09 | 2026-09-24 | **展示链路**：输出 展示大类（论文/新闻）/展示小类/归入大类（A/B/C/D）三字段＋看板展示列＋stats.displayChain（纯展示不影响评分，依据《新闻类型展示分类.xlsx》）；**B1 补词"探析"**；**LLM 提示词 v3 预置叶冻结**——除非完全无关判域外，否则必须归入预置叶子节点/预置类型，禁止自拟"扩展:"新路径（run_llm 层，决策版本 2026-09-24-v3） |
